...
namespace ConwayGameOfLife
{
    public class ConwayGameOfLife
    {
        ...
        internal void SetLifeBehaviour(ILifeBehaviour behaviour)
        {
            this.lifeBehaviour = behaviour;
        }
        ...
        public class StandardLifeBehaviour : ILifeBehaviour
        {
            ...
            {
                return (!livingCell && neighbourCount == 3) ||
                       (livingCell && (neighbourCount == 2 || neighbourCount == 3));
            }
        }
        ...
        public class HighLifeBehaviour : ILifeBehaviour
        {
            public bool CellShouldLive(bool livingCell, int neighbourCount)
            {
                return (!livingCell && (neighbourCount == 3 || neighbourCount == 6)) ||
                       (livingCell && (neighbourCount == 2 || neighbourCount == 3));
            }
        }
    }
